#!/bin/bash
# 对 ablation_wo_semantic_prior epoch_60ema 在 Vid4、UDM10、REDS4 上进行评估
# 评估结果写入 results/metrics/eval_ablation_wo_semantic_prior_ep60.md

set -e
cd /home/ubuntu/lib/ST_VSR_Project

EXP="ablation_wo_semantic_prior/epoch_60ema"
OUT_MD="results/metrics/eval_ablation_wo_semantic_prior_ep60.md"
...
cat > "$OUT_MD" << 'EOF'
# ablation_wo_semantic_prior — epoch_60ema 评估结果
