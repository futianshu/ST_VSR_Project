################################################
# ablation_wo_semantic_prior — epoch_60ema
# checkpoint: checkpoints/ablation_wo_semantic_prior/st_vsr_epoch_60.pth
################################################

set -e
cd /home/ubuntu/lib/ST_VSR_Project

CKPT="checkpoints/ablation_wo_semantic_prior/st_vsr_epoch_60.pth"
